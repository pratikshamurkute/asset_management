...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('')) < Date.now()) //AdminLTE:Demo:MessageShowed
    {
      localStorage.setItem('AdminLTE:Demo:MessageShowe', (Date.now()) + (15 * 60 * 1000))
