...
<div class="wrapper">
    ...
    <?php
            ...
            if(isset($_GET['id']))
            {
            $var = "select * from sub_category where sub_categ_id='".$_GET['id']."'";
                    ...
                    <form id="quickForm" method="post">
                        <div class="card-body">
                            ...
                            <div class="modal-footer justify-content-between">
                                <a href="sub_category.php"><button type="button" class="btn btn-default" data-dismiss="modal">Back</button></a>
