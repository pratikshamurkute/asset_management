...
<div class="wrapper">
    ...
    <?php
            ...
            if(isset($_GET['id']))
            {
            $var = "select * from states where id='".$_GET['id']."'";
                    ...
                    <form id="quickForm" method="post">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="states" value="<?php echo $row['states']; ?>" class="form-control" >
                            </div>
                               
                            </div>                 
                            <div class="modal-footer justify-content-between">
                                <a href="state.php"><button type="button" class="btn btn-default" data-dismiss="modal">Back</button></a>
