            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <?php
                            include "include/config.php";
                            $view=mysqli_query($con, "SELECT * FROM items WHERE MONTH(warranty_date) = MONTH(CURRENT_DATE) + 1") or die(mysqli_error($con));
                        ?>
                        <div class="card">
...
//     $sql=mysqli_query($con,"insert into items(item_name, category_name, sub_categ_name, item_price, servicing_date, warranty_date) values ('$item_name', '$category_name', '$sub_categ_name', '$item_price', '$servicing_date', '$warranty_date')");
...
//     $dlt = mysqli_query($con,"DELETE FROM items WHERE item_id='".$_GET['id']."'")or die (mysqli_error($con));
