                        ...
                        <div class="modal-content">
                            ...
                            <form id="quickForm" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_brand" class="form-control" id="">
                                </div>
                                <div class="form-group">
                                    <label for="">Specification</label>
                                    <textarea type="text" name="item_specify" class="form-control" id=""></textarea>
                                </div>
                                <div class="form-group">
      ...
      <!-- /.modal -->
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                <?php
                 include "include/config.php";
                $view=mysqli_query($con, "select * from items") or die(mysqli_error($con));
                ?>
                <div class="card">
