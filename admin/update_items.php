...
<div class="wrapper">
    ...
    <?php
            ...
            if(isset($_GET['id']))
            {
            $var = "select * from items where item_id='".$_GET['id']."'";
                    ...
                    <form id="quickForm" method="post">
                        <div class="card-body"> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="item_brand" value="<?php echo $row['item_brand']; ?>" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="">Specification</label>
                                <input type="text" name="item_specify" value="<?php echo $row['item_specify']; ?>" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="">Item Price</label>
                                <input type="text" name="item_price" value="<?php echo $row['item_price']; ?>" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="">Servicing Date</label>
                                <input type="date" name="servicing_date" value="<?php echo $row['servicing_date']; ?>" class="form-control" >
                            </div>
                            <div class="form-group">
